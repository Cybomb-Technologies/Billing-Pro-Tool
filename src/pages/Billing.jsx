...
const Billing = () => {
  ...
  const buildInvoicePayload = useCallback(() => {
      ...
      const currentCount = backend.invoices ? backend.invoices.length : 0;
      const sequentialCount = (currentCount + 1).toString().padStart(3, '0'); 
      const invoiceNum = `${day}${month}${year}${sequentialCount}`;
            ...
            <div class="section">
              <table style="width: 50%; margin-left: auto;">
                <tbody>
                  ...
                  ${(() => {
                    // Fallback to average tax display if breakdown missing 
                          ...
                          <Col md={6}>
                            <InputGroup>
                                    ...
                                    <Form.Control 
                                      ...
                                      autoComplete="off"
                                    />
                                    <Button variant="primary" onClick={handleCustomerSearchSubmit} disabled={!customerSearch.trim()}>
                                        Check
                                    </Button>
                            </InputGroup>
              ...
              <Row className="g-2 mb-3">
                 ...
                 <Col md={6}>
                  ...
                  <Card className="shadow-sm border-0 flex-grow-1 overflow-hidden d-flex flex-column">
                                    ...
                                    {invoiceItems.length === 0 && (
                                        <tr>
                                            <td colSpan="8" className="text-center py-5 text-muted">
                                                Scan barcode or click items from the list on the right.
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
                       ...
                       <Card.Footer className="bg-white border-top flex-shrink-0">
                           <Row>
                               <Col>
                             ...
                             {filteredProducts.map(p => {
                                 ...
                                 return (
                                     <Col xs={6} key={p._id}>
                                         ...
                                         >
                                             <Card.Body className="p-2 d-flex flex-column text-center">
